# Contributing to registry-docs

First and foremost, thank you! We appreciate that you want to contribute to registry-docs, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for registry-docs**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for registry-docs:

- star the [project](https://github.com/rwmbook/registry-docs)
- tweet your support for registry-docs
...
- **version**: (required) please note the version of registry-docs are you using
...
The original poster or the maintainers of registry-docs may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/registry-docs
